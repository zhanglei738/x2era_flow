                ...
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">点评数据上传</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                        <div class="logo-element">点评数据上传
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${ctx!}/user/index?pageNumber=1">用户管理</a>
                            </li>
                         <#--<@shiro.hasPermission name="system:user:index">

                         </@shiro.hasPermission>-->
                            <#--<li>-->
                                <#--<a class="J_menuItem" href="${ctx!}/role/index">角色管理</a>-->
                            <#--</li>-->
                         <#--<@shiro.hasPermission name="system:role:index">

                         </@shiro.hasPermission>-->
                            <li>
                                <a class="J_menuItem" href="${ctx!}/resourceFile/index">资源管理</a>
                            </li>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#"><#--<@shiro.principal type="net.sppan.base.entity.User" property="nickName"/>-->
                                <i class="fa fa-user"></i> <span class="label label-primary"></span>您好，【${(userInfo.userName)!}】
                            </a>
